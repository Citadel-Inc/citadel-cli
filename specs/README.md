...
| cli-watch | 051430ZMAY26 | End-to-end: Citadel `listwatch` SSE on all list paths (polling v1: init/add/update/remove, `:keepalive`, Last-Event-ID), citadel-cli `--watch` + B6 httptest. P2 C2 operator live smoke remains human. |
