...
func init() {
	...
	addOutputFlag(releaseListCmd)
	addGetOutputFlag(releaseLatestCmd, releaseViewCmd, releaseCreateCmd, releaseEditCmd)
	...
	addOutputFlag(releaseAssetListCmd)
	addGetOutputFlag(releaseAssetUploadCmd)
	addMutationOutputFlag(releaseAssetDeleteCmd)
